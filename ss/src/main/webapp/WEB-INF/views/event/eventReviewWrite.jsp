			...
			<main class="col-6 offset-3 py-md-1 pl-md-5 bd-content board-article border-end border-start" style="height: 100vh;" role="main">
				<article class="container-fluid" >
					<form name="write" method="post" action="eventReviewWrite.do" onsubmit="return DoSubmit();">
						...
						<span>${ev.event_number}.${ev.event_title}</span>
						...
						<div class="row">
							<div class="form-group col-12">
								<div class="input-group input-group-sm">
									...
									<input type="text" name="comment_title" class="form-control form-control-sm" value="${erv.comment_title}" id="${erv.comment_title}" maxlength="256" required="">
								</div>
							</div>
							<div class="pt-1">
							<textarea id="summernote" name="comment_content" value="${erv.comment_content}">${erv.comment_content}</textarea>
							</div>
						</div>
